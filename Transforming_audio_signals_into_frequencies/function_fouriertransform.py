...
def choose_frequencies():
    ...
    :return: [int, int, int]
    """
    # provide three frequencies between 1 and 50
    freq1 = 4
    freq2 = 37
    freq3 = 12
    # end
...
def add_the_waves(freqs):
    ...
    # sum the waves together to form sum_waves
    sum_waves = w1+w2+w3
    # end
...
def demo_fft(sum_waves):
    ...
    # create a Fast Fourier Transform of the waveform using scipy.fftpack.fft
    # named 'y_fft'
